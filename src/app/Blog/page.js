    ...
    <main className=" bg-white w-screen h-screen px-10 gap-10">
      ...
      <div className="flex flex-col mx-auto w-4/5 mt-8 flex-wrap justify-start items-start">
        {blogData.map((item , index) => {
          return (<Link href={item.Link}><div key ={index} className="w-[250px] h-[300px] bg-black flex flex-col rounded-lg shadow-lg shadow-gray-800 justify-between transform hover:scale-105 transition duration-200 items-center">
            <img className="object-cover" src={item.bImage} />
